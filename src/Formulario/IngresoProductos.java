   ...
   void mostrartipoproducto(){
    ...
    void cargar(String valor) {
        ...
        try{
            ...
            //Se esta imprimiendo el Id de tipo Producto
            System.out.print(tipo);
            String cap="";
            String consul ="SELECT * FROM tipoproducto WHERE idtip='"+tipo+"'";
            ...
            cbotipo.setSelectedItem(cap.toString());
...
// TODO add your handling code here:
     String sql="UPDATE producto SET precio = '"+txtpre.getText()+"',descripcion ='"+txtdes.getText()+"',Stock = '"+txtstock.getText()+"',idtip='"+cbotipo.getSelectedIndex()+"' WHERE cod_pro = '"+txtcod.getText()+"'"; 
    try {
        PreparedStatement pst = cn.prepareStatement(sql);
        pst.executeUpdate();
